...
async def main():
    async with async_playwright() as p:
        ...
        *, *::before, *::after {
        ...
        await page.screenshot(path="jules-scratch/verification/final_tenants_page_verification.png")
        ...
        await page.wait_for_timeout(500)
        await page.screenshot(path="jules-scratch/verification/final_about_page_verification.png")
